require(['tquery.controls', 'tquery.minecraft', 'tquery.skymap', 'tquery.grassground', 'tquery.keyboard', 'tquery.loaders', 'tquery.domevent', 'tquery.renderers', 'tquery.htmlmixer'], function() {
